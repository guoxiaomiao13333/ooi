...
public class CreateQrcode_IDCard {
	...
	public static void main(String[] args) throws IOException {
        ...
        String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:https://ps.ssl.qhimg.com/dm/365_365_/t013d310912d4d1d658.jpg\n" +
                   "FN:姓名:郭小淼\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:13315655443\n"+
                   "TEL;WORK,VOICE:无\r\n"+
                   "URL;WORK:http://www.hevttc.edu.cn\n"+
                   "EMAIL;INTERNET,HOME:1518831451@qq.com\n"+
                   "END:VCARD";//二维码扫出来的内容
        //得到一个二维数组
        ...
        Image logo=ImageIO.read(new File("D:/头像/gxmid.jpg"));
        int logosize=50;
        int logox=(imagesize-logosize)/2;
        gs1.drawImage(logo,logox, logox, logosize, logosize, null);
        gs1.dispose();
    	bufferedimage.flush();
    	ImageIO.write(bufferedimage,"png",new File("D:/idcard.png"));
	}
}
